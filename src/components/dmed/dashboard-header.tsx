    ...
    <header className="sticky top-0 z-50 flex items-center justify-between gap-4 p-3 bg-background/80 backdrop-blur-sm border-b border-border">
      ...
      <div className="flex items-center gap-4">
        <div className="text-right">
          <p className="text-xs font-medium uppercase text-foreground/80 tracking-wider">{dictionary.header.republic}</p>
          <p className="text-[10px] uppercase text-muted-foreground tracking-wider">{dictionary.header.ministry}</p>
        </div>
        <DmedLogo />
        <LanguageSwitcher />
        <FullscreenButton />
